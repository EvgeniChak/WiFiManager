...
const char HTTP_SAVED[] PROGMEM = "<div class='msg'>Saving Credentials<br/>Trying to connect Docking Station to network.<br />If it fails reconnect to AP to try again</div>";
